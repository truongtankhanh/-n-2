...
public class BranchRecyclerViewAdapter extends RecyclerView.Adapter<BranchRecyclerViewAdapter.BranchViewHolder> {
    ...
    public BranchViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view;
        view = LayoutInflater.from(context).inflate(R.layout.cardview_item_branch_like,parent,false);
    ...
    public void onBindViewHolder(@NonNull final BranchViewHolder holder, final int position) {
        ...
        holder.cardview_branch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context,BranchLikeDetailsActivity.class);
                intent.putExtra("class",BranchLikeDetailsActivity.class.getSimpleName());
                ...
                branchList.get(position).setAction_like(0);
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        switch (item.getItemId()) {
                            case R.id.action_details:
                                Intent intent0 = new Intent(context,BranchLikeDetailsActivity.class);
                            ...
                            case R.id.action_map:
                                ...
                                String className = com.gmail.khanhit100896.foody.branch.BranchRecyclerViewAdapter.class.getSimpleName();
                            ...
                            case R.id.action_dislike:
                                ...
                                StringRequest stringRequest = new StringRequest(Request.Method.POST, getURL,
                                    ...
                                    protected Map<String, String> getParams(){
                                        ...
                                        params.put("actionLike", String.valueOf(branchList.get(position).getAction_like()));
    ...
    static class BranchViewHolder extends RecyclerView.ViewHolder{
        ...
        BranchViewHolder(View itemView) {
            ...
            cardview_branch = itemView.findViewById(R.id.cardview_branch_like);
        }
    }
}
