...
public class RestaurantBranchLikeActivity extends AppCompatActivity {
    ...
    protected int idRes, actionLike;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_restaurant_branch_like);
...
//        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.activity_like_details, menu);
        return true;
    }
