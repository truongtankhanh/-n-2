...
public class RestaurantBranchTouchActivity extends AppCompatActivity {
    ...
    protected int idRes, actionTouch;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_restaurant_branch_touch);
    ...
    private void init() {
        ...
        this.idRes = intent.getExtras().getInt("ID");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.activity_touch_details, menu);
        return true;
    }
            ...
            case R.id.action_distouch:
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, getURL,
                        new Response.Listener<String>() {
                            ...
                            public void onResponse(String response) {
                                if(response.trim().equals("success")){
                                    Toast toast = Toast.makeText(getApplicationContext(),"Đã xóa "+ txtResName.getText()
                    ...
                    protected Map<String, String> getParams(){
                        ...
                        params.put("id", String.valueOf(idRes));
