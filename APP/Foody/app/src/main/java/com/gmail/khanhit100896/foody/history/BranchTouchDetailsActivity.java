...
public class BranchTouchDetailsActivity extends AppCompatActivity {
    ...
    protected int idBranch, actionTouch;

    protected String getURl = Config.getConfig().getPathGetAllComment();
    private String getURLBranch = Config.getConfig().getPathUpdateTouchBranch();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_branch_touch_details);
...
//                        ,getApplicationContext(), new GeocoderHandler());
        ...
        this.imgComment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (user != null) {
                    ...
                    String context = BranchTouchDetailsActivity.class.getSimpleName();
    ...
    private void init() {
        ...
        actionTouch = intent.getExtras().getInt("ActionTouch");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_branch_touch_details, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        else if(id == R.id.action_distouch){
                    ...
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            if(response.trim().equals("success")){
                                Toast toast = Toast.makeText(getApplicationContext(),"Đã xóa "+ txt_name_branch_details.getText()
