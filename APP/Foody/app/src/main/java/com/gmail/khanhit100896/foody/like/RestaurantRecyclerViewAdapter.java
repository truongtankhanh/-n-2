...
public class RestaurantRecyclerViewAdapter extends RecyclerView.Adapter<RestaurantRecyclerViewAdapter.RestaurantViewHolder> {
    ...
    public RestaurantViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view;
        view = LayoutInflater.from(context).inflate(R.layout.cardview_item_restaurant_like,parent,false);
    ...
    public void onBindViewHolder(@NonNull final RestaurantViewHolder holder, final int position) {
        ...
        holder.cardview_restaurant.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context,RestaurantBranchLikeActivity.class);
                ...
                restaurantList.get(position).setAction_like(0);
        ...
        holder.iv_menu_res.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                popupMenu.inflate(R.menu.menu_restaurant_like);
                            ...
                            case R.id.action_dislike:
                                ...
                                StringRequest stringRequest = new StringRequest(Request.Method.POST, getURL,
                                    ...
                                    protected Map<String, String> getParams(){
                                        ...
                                        params.put("actionLike", String.valueOf(restaurantList.get(position).getAction_like()));
    ...
    static class RestaurantViewHolder extends RecyclerView.ViewHolder{
        ...
        RestaurantViewHolder(View itemView) {
            ...
            cardview_restaurant = itemView.findViewById(R.id.cardview_restaurant_like);
        }
    }
