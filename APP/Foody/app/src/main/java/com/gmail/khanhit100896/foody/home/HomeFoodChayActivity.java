...
public class HomeFoodChayActivity extends AppCompatActivity {
    ...
    protected Toolbar app_bar_home_food_chay;
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         */
        app_bar_home_food_chay = findViewById(R.id.app_bar_home_food_chay);
        setSupportActionBar(app_bar_home_food_chay);
        this.app_bar_home_food_chay.setTitle("Món chay - món Việt");

        this.recyclerFoodChay = findViewById(R.id.recycler_chay_food);
        this.foodChayList = new ArrayList<>();
        this.appBarLayout = findViewById(R.id.appBarLayout);
        /*
         */

        // Gọi hàm lấy tất cả các món chay
        getAllFoodChay(this.getURL);

        // Bắt sự kiện ẩn appBarLayout khi scroll up
//        this.recyclerFoodChay.addOnScrollListener(new RecyclerView.OnScrollListener() {
//            @Override
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, getURL, null,
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                         ...
                         */
                        adapter = new FoodRecyclerViewAdapter(getApplicationContext(),foodChayList);
                        recyclerFoodChay.setLayoutManager(new GridLayoutManager(getApplicationContext(),2));
